...
window.addEventListener('load', function () {
  ...
  var roomId = rand(0, 1000);
  var channel = socket.channel("game:" + roomId, { token: 5297 });
  channel.join().receive('ok', function () {
    return console.log("connected to room " + roomId + "!");
  });
  ...
  channel.on('state:change', function (msg) {
    console.log(msg);
