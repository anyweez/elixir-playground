...
window.addEventListener('load', function () {
    ...
    // Phoenix stuff
    var socket = new _phoenixSocket.Socket("ws://localhost:4000/socket", { params: { userToken: "123" } });
    socket.connect();

    var channel = socket.channel("world:first", {});
    ...
    sendButton.addEventListener('click', function () {
        ...
        channel.push('new_msg', {
            body: message
        }, 10000).receive("ok", function (msg) {
            return console.log("message sent!", msg);
        }).receive("error", function (reasons) {
            return console.log("serverside error", reasons);
        }).receive("timeout", function () {
            return console.log("Networking issue...");
        }); // timeout?
    });
});
},{"dateformat":2,"phoenix-socket":3}],2:[function(require,module,exports){
/*
 * Date Format 1.2.3
